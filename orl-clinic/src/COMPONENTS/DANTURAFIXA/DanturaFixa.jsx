...
import Image1 from '../../assets/implant.png'; // Exemplu de imagine pentru procedura de dinti ficsi
...
import DoctorImage from '../../assets/implant.png'; // Imaginea doctorului
    ...
    <div className="dinti-ficsi">
      ...
      <section className="procedura-section">
        ...
        <div className="procedura-steps">
          <div className="step">
            <img src={Image1} alt="Consult Inițial" />
          ...
          <div className="step">
            <img src={Image2} alt="Planificarea Intervenției" />
          ...
          <div className="step">
            <img src={Image3} alt="Intervenția Chirurgicală" />
